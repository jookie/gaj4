...
peers would mine blocks in the browser and communicate via web RealTimeCommunication the browser. This module simply initializes socket.io and configures it in a way that single audio/video/screen stream can be shared/relayed over unlimited users without any bandwidth/CPU usage issues. Everything happens peer-to-peer!
<!-- 
